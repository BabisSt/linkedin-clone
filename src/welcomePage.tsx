...
export default function WelcomePage({ setShowNavFooter }: WelcomePageProps) {
  ...
  return (
    <div>
      <h4 className="flex flex-row justify-center pt-24 text-2xl font-extrabold text-white md:text-3xl lg:text-4xl">
        Welcome to
      </h4>
      ...
      <p className="flex flex-row justify-center text-lg font-normal lg:text-xl text-gray-300">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-between items-center h-full max-w-xs">
              <div>
                ...
                <p className="text-md font-normal  text-center text-gray-400">
              ...
              <button
                ...
                className="mt-4 font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-800 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2 transition-transform transform active:scale-95"
              >
                Login
              </button>
            </div>
